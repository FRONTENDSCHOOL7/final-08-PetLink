...
import { CommunityCategory, Container, GlobalStyle, Header, IconMapMark, IconSearch, IconShareInfoMap, IconUserProfile, InfoShareButton, MyLocation, PostReaction, PostSubTxt, PostTitle, ShareInfoMap, ShareInfoPost } from './CommunityList.style';
